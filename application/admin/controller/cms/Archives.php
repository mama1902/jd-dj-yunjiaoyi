...
class Archives extends Backend
{
    ...
    protected $searchFields = 'id,title,sku';
    ...
    public function content($model_id = null)
    {
        ...
        if ($this->request->isAjax()) {
            ...
            $this->searchFields = "archives.id,archives.title,archives.sku,archives.memo";
            $this->relationSearch = true;
        ...
        if ($model['table'] == 'cms_addonproduct') {
            return $this->view->fetch('contentprice');
        }
    ...
    public function edit($ids = null)
    {
        ...
        if ($model['table'] == 'cms_addonproduct') {
            return $this->view->fetch('editprice');
        }
    ...
    public function get_fields_html()
    {
        ...
        if ($channel) {
            ...
            $this->success('', null, ['html' => $this->view->fetch('cms/common/fields'), 'publishfields' => $publishfields]);
        } else {
